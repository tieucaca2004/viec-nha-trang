...
/// (đặc tả mục 13). Lương là trường bắt buộc (mục 21): không cho qua bước nếu thiếu.
...
class _PostJobWizardScreenState extends State<PostJobWizardScreen> {
  ...
  Future<void> _loadOptions() async {
    final categories = await context.read<JobsService>().categories();
    final locations = await context.read<ProfileService>().myEmployerLocations();
    setState(() {
